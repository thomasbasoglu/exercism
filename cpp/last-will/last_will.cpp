...
namespace estate_executor{
    ...
    int assemble_code(){
        int totred{zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment()};
        int totblue{khan::blue::code_fragment() + garcia::blue::code_fragment()+zhang::blue::code_fragment()};
        return  totred * totblue;
    }
}