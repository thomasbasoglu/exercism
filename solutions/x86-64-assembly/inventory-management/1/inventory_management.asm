...
get_box_weight:
    ...
    imul di, si ; getting first argument times the second 
    add ax, di ; adding to the result 

    imul dx, cx ; getting third argument times the fourth 
    add ax, dx ; adding to the result 
    movzx eax, ax ; Converting the result to 32 bit after 16 bit calculations 
    ret
